...
--
-- Host: localhost
-- Generation Time: Oct 12, 2015 at 05:05 PM
...
(8, 'SomeContent\r\n(insert quiz specifc remarks)\r\nEND OF QUIZ', 'The Eighth Question', '8.png', NULL),
...
CREATE TABLE IF NOT EXISTS `question_answer` (
  ...
  `SHORT_ANSWER_ID` int(11) DEFAULT NULL,
...
INSERT INTO `question_answer` (`question_QUESTION_ID`, `answer_ANSWER_ID`, `CONNECTION_ID`, `PARENT_ID`, `LOOP_CHILD_ID`, `TYPE`, `quiz_QUIZ_ID`, `DEPTH`, `SHORT_QUESTION_ID`, `SHORT_ANSWER_ID`) VALUES
(1, NULL, 1, NULL, NULL, 'question', 1, 0, 1, NULL),
(NULL, 1, 2, 1, NULL, 'answer', 1, 1, NULL, 1),
(NULL, 2, 3, 1, NULL, 'answer', 1, 1, NULL, 2),
(2, NULL, 4, 2, NULL, 'question', 1, 2, 2, NULL),
(3, NULL, 5, 3, NULL, 'question', 1, 2, 3, NULL),
(NULL, 3, 6, 4, NULL, 'answer', 1, 3, NULL, 3),
(NULL, 4, 7, 4, NULL, 'answer', 1, 3, NULL, 4),
(NULL, 5, 8, 5, NULL, 'answer', 1, 4, NULL, 5),
(NULL, 6, 9, 5, NULL, 'answer', 1, 4, NULL, 6),
(4, NULL, 10, 6, NULL, 'question', 1, 5, 4, NULL),
(5, NULL, 11, 7, NULL, 'question', 1, 5, 5, NULL),
(6, NULL, 12, 8, NULL, 'question', 1, 5, 6, NULL),
(7, NULL, 13, 9, NULL, 'question', 1, 5, 7, NULL),
(NULL, 7, 14, 10, NULL, 'answer', 1, 6, NULL, 7),
(NULL, 8, 15, 10, 38, 'answer', 1, 6, NULL, 8),
(NULL, 9, 16, 11, 38, 'answer', 1, 6, NULL, 9),
(NULL, 10, 17, 11, 38, 'answer', 1, 6, NULL, 10),
(NULL, 11, 18, 12, 38, 'answer', 1, 6, NULL, 11),
(NULL, 12, 19, 12, 38, 'answer', 1, 6, NULL, 12),
(NULL, 13, 20, 13, 38, 'answer', 1, 6, NULL, 13),
(NULL, 14, 21, 13, 38, 'answer', 1, 6, NULL, 14),
(8, NULL, 38, 14, NULL, 'question', 1, 7, 8, NULL);
...
CREATE TABLE IF NOT EXISTS `quiz` (
  ...
  `IS_SAVABLE` tinyint(1) NOT NULL DEFAULT '1',
...
(1, 1, 1, 'Test Quiz 1', 'This is a Test case Quiz', 1, NULL, '00:00:00', 0, '2015-01-01 06:41:00', NULL, NULL, NULL, NULL, 1, 1),
(32, 2, 1, 'Test Quiz 2', 'This is a Test case (No Qs & A''s)', 1, NULL, '00:00:00', 0, '2015-01-01 06:41:00', NULL, NULL, NULL, NULL, 1, 1),
(33, 3, 1, 'Plagiarism: Beginner', 'Test case Quiz (no Q & A''s)', 0, NULL, '00:00:00', 0, '2015-01-01 06:41:00', NULL, NULL, NULL, NULL, 1, 1);
